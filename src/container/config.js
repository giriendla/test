...
const Config = {
    ...
    "mainnav": [
        ...
        { name: "Register", link: "/register", icon: "login.png", isLogin: false, template: "single" },
        { name: "Forgot Password", link: "/forgotpassword", icon: "forgotpassword.png", isLogin: false, template: "beforeLogin" },
        { name: "Reset Password", link: "/resetpassword", icon: "resetpassword.png", isLogin: false, template: "beforeLogin" },
    ],
    "api": {
        "dashboard": {
            "url": "/api/v1/vendors/dashboard", "type": "get", 'isToken': true
        },
        "posts": {
            "url": "/posts", "type": "get"
        },
        'register': {
            'register': {
                'url':'/api/v1/vendors/register', 'type': 'post', 'isToken': false
            },
            'fetchCompanyDetails':{
                'url':'/api/v1/vendors/fetch_company_details/', 'type': 'get', 'isToken': false
            }
        },
        'employees': {
            'list': {
                'url': '/api/v1/vendors/employees', 'type': 'get', 'isToken': true
            },
            'create': {
                'url': '/api/v1/vendors/create_employee', 'type': 'post', 'isToken': true
            },
            'edit': {
                'url': '/api/v1/vendors/update_employee', 'type': 'post', 'isToken': true
            },
            'dispute': {
                'url': '/api/v1/vendors/dispute_employee/', 'type': 'get', 'isToken': true
            },
            'employee': {
